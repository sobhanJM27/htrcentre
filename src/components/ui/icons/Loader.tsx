  ...
  if (type === "button")
    return (
      <div role="status" className="flex items-center justify-center">
        <svg
          aria-hidden="true"
          className="w-4 h-4 animate-spin text-primary/30 fill-primary"
          viewBox="0 0 100 101"
          fill="none"
  ...
  return (
    <div className="w-full h-full p-10 flex items-center justify-center">
      <div className="flex items-center gap-3">
        <div className="w-3 h-3 rounded-full animate-dot-bounce1 bg-primary"></div>
        <div className="w-3 h-3 rounded-full animate-dot-bounce2 bg-primary"></div>
        <div className="w-3 h-3 rounded-full animate-dot-bounce3 bg-primary"></div>
      </div>
    </div>
  );
};
